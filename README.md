...
A backend monolithic built using **Spring Boot**  and **Java 8 - 17**  that manages a product catalogue and exposes REST APIs for product operations such as add, search, filter, sort, pagination, and inventory value calculation.
